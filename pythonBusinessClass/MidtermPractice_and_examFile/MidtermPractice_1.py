'''
Create a Python GUI application that allows the user to input their weight and height
and calculate their BMI. The app should display the result with a message indicating
if the user is Underweight, Normal weight, or Overweight based on their BMI.
Add an "Exit" button to close the application and ensure that all input values are properly validated.
'''
...
def show_BMI_Result():
    try:
        ...
        if BMI_Value < 18.5:
            ...
            infoShow_label.config(text=f"Your BMI is {BMI_Value}. You are Normal.")
        elif BMI_Value <= 35:
